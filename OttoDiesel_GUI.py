...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.le_CR, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_CR, 5, 0, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.grid_Output.addWidget(self.label_13, 5, 0, 1, 1)
        ...
        self.le_p3 = QtWidgets.QLineEdit(self.gb_Input)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.le_p3.sizePolicy().hasHeightForWidth())
        self.le_p3.setSizePolicy(sizePolicy)
        self.le_p3.setMaximumSize(QtCore.QSize(200, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.le_p3.setFont(font)
        self.le_p3.setClearButtonEnabled(True)
        self.le_p3.setObjectName("le_p3")
        self.gridLayout.addWidget(self.le_p3, 4, 1, 1, 1)
        self.lbl_p3 = QtWidgets.QLabel(self.gb_Input)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_p3.sizePolicy().hasHeightForWidth())
        self.lbl_p3.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_p3.setFont(font)
        self.lbl_p3.setTextFormat(QtCore.Qt.PlainText)
        self.lbl_p3.setObjectName("lbl_p3")
        self.gridLayout.addWidget(self.lbl_p3, 4, 0, 1, 1, QtCore.Qt.AlignRight)

        self.le_T5 = QtWidgets.QLineEdit(self.gb_Output)
        self.le_T5.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.le_T5.sizePolicy().hasHeightForWidth())
        self.le_T5.setSizePolicy(sizePolicy)
        self.le_T5.setMinimumSize(QtCore.QSize(0, 0))
        self.le_T5.setMaximumSize(QtCore.QSize(200, 16777215))
        self.le_T5.setBaseSize(QtCore.QSize(150, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.le_T5.setFont(font)
        self.le_T5.setObjectName("le_T5")
        self.grid_Output.addWidget(self.le_T5, 5, 1, 1, 1)
        self.lbl_T5Units = QtWidgets.QLabel(self.gb_Output)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_T5Units.sizePolicy().hasHeightForWidth())
        self.lbl_T5Units.setSizePolicy(sizePolicy)
        self.lbl_T5Units.setBaseSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_T5Units.setFont(font)
        self.lbl_T5Units.setObjectName("lbl_T5Units")
        self.grid_Output.addWidget(self.lbl_T5Units, 5, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.cmb_OttoDiesel.setItemText(2, _translate("Form", "Dual cycle"))
        self.gb_Output.setTitle(_translate("Form", "Output"))
        self.label_7.setText(_translate("Form", "T4"))
        self.label_13.setText(_translate("Form", "T5"))
        ...
        self.lbl_T5Units.setText(_translate("Form", "C"))
        ...
        self.le_p3.setText(_translate("Form", "8.0"))
        self.le_p3.setPlaceholderText(_translate("Form", "turbine isentropic efficiency 0.0<eta<=1.0"))
        self.lbl_p3.setText(_translate("Form", "p3/p2"))
